<nav class="navbar navbar-default navbar-fixed-top wow fadeIn animated" style="background-color: white; border-bottom: 1px solid #DBDBDB;">
    <div class="container">
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">CICT Web Portal</a>
        </div>
        <div class="collapse navbar-collapse navbar-mynav-collapse" id="nav">
            <ul class="nav navbar-nav pull-right hidden-xs">
                <li class="hidden"><a class="page-scroll" href="#page-top"></a></li>
                <li><a href="#" id="btn-logout">Log Out &nbsp;&nbsp;</a></li>
            </ul>
            <ul class="nav navbar-nav hidden-lg hidden-md hidden-sm" id="nav_collapse_sm">
            <li class="profile-li" style="border-left: 20px solid #1A4D57;">
              <div class="profile-userinfo text-center" >
                ...
                <div id ="side-bar-id_sub" class="profile-stud-id span_grey">
                </div>
              </div></li>
            ...
            <li><a href="#" id="btn-logout_sub" style="padding-left: 23%"><span class="showopacity glyphicon glyphicon-user"></span> LOG OUT &nbsp;&nbsp;</a></li>
          </ul>
        </div><!-- .navbar-collapse -->
    </div><!--.container -->
</nav><br><br><br><br>
