  <nav class="navbar navbar-default navbar-fixed-side wow fadeIn animated hidden-xs" style=" background-color:white; ">
    ...
    <li class="profile-li" style="border-left: 20px solid #1A4D57;">
      <div class="profile-userinfo text-center" >
        <div class="profile-pic">
          <img id="profile-pic_img" onload="onload_display_picture(this.id)" class="img-responsive img-circle text-center" style="border: 1px solid #EEEEEE" width="100" height="100" alt="">
        </div>
    ...
    <li><a href="#" id="btn_grade" style="padding-left: 23%"><span class="showopacity glyphicon glyphicon-list-alt"></span> GRADES</a></li>
