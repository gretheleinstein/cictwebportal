  ...
  <table>
    <tr>
      ...
      <td width="90%"><table class="name_header">
        <tr><td></td></tr>
        <tr><td width="2%"></td><td width="12%">Name:</td><td width="40%">{{ $student->last_name.", ".$student->first_name." ".$student->middle_name }}</td>          <td width="21%">Academic Term and Year:</td><td width="25%">{{ $year_sem }}</td></tr>
        <tr><td width="2%"></td><td width="12%">Student No.:</td><td width="40%">{{ $student->id }}</td>   <td width="21%">Year Level:</td><td width="15%">{{ $student->year_level }}</td></tr>
        <tr><td width="2%"></td><td width="12%">Course:</td><td width="40%">{{ $student->CURRICULUM_id }}</td></tr>
        <tr><td></td></tr>
      </table></td>
    </tr>
  </table>
